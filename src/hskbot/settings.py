"""
Django settings for hskbot project.
...
SECRET_KEY = 'django-insecure-rqak^4)5+(2szubu0=tx3dpp)-suh0s0wh0=1o8z1*rv86to3+'
...
WSGI_APPLICATION = 'hskbot.wsgi.application'
