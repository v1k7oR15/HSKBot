...
from .views import base_view, chat_view, login_view, register_view, palabra_view, mostrar_palabras_view, eliminar_palabra_view, editar_palabra_view, exportar_palabras_excel, editar_usuario
